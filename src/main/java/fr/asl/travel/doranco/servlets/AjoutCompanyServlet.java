 ...
 */
@WebServlet("/ajouterCompany")
public class AjoutCompanyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        compagnieService.ajouterCompagnie(request.getParameter("NOM_COMPANY"));
