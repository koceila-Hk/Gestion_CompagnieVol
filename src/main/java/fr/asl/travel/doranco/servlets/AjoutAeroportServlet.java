 ...
 */
@WebServlet("/ajouterAeroport")
public class AjoutAeroportServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		aeroportService.ajouterAeroport(request.getParameter("NOM_AEROPORT"));
